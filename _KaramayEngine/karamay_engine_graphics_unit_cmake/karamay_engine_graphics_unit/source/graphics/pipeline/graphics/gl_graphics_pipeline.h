...
#define DEFINE_SHADER_PARAMETER_IMAGE(GLSL_IMAGE_T, V_NAME)\
glsl_##GLSL_IMAGE_T V_NAME;\


#define DEFINE_SHADER_PARAMETER_IMAGE_ARRAY(GLSL_IMAGE_T, V_NAME, ARRAY_SIZE)\
glsl_##GLSL_IMAGE_T V_NAME[ARRAY_SIZE]; \


#define DEFINE_SHADER_PARAMETER_SAMPLER(GLSL_SAMPLER_T, V_NAME)\
glsl_##GLSL_SAMPLER_T V_NAME;\

#define DEFINE_SHADER_PARAMETER_SAMPLER_ARRAY(GLSL_SAMPLER_T, V_NAME, ARRAY_SIZE)\
glsl_##GLSL_SAMPLER_T V_NAME[ARRAY_SIZE]; \

#define DEFINE_SHADER_PARAMETER_ATOMIC_COUNTER(V_NAME)\
glsl_atomic_uint V_NAME;\

#define DEFINE_SHADER_PARAMETER_ATOMIC_COUNTER_ARRAY(V_NAME, ARRAY_SIZE)\
glsl_atomic_uint V_NAME[ARRAY_SIZE];\

#define DEFINE_SHADER_PARAMETER_UNIFORM_BLOCK(GLSL_UNIFORM_BLOCK_T, V_NAME)\
GLSL_UNIFORM_BLOCK_T V_NAME;

#define DEFINE_SHADER_PARAMETER_UNIFORM_BLOCK_ARRAY(GLSL_UNIFORM_BLOCK_T, V_NAME, ARRAY_SIZE)\
GLSL_UNIFORM_BLOCK_T V_NAME[ARRAY_SIZE];\

#define DEFINE_SHADER_PARAMETER_SHADER_STORAGE_BLOCK(GLSL_SHADER_STORAGE_BLOCK_T, V_NAME)\
GLSL_SHADER_STORAGE_BLOCK_T V_NAME; \

#define DEFINE_SHADER_PARAMETER_SHADER_STORAGE_BLOCK_ARRAY(GLSL_SHADER_STORAGE_BLOCK_T, V_NAME, ARRAY_SIZE)\
