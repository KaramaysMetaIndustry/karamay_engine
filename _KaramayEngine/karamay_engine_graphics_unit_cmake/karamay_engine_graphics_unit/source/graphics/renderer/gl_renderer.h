...
public:
    ...
    gl_texture_cube* build_texture_cube(gl_texture_internal_format format, uint32 width, uint32 height, uint32 mipmaps_num)
    {
        auto _tex_cube = new gl_texture_cube(mipmaps_num, format, width, height);
        _texture_cubes.push_back(_tex_cube);
        return _tex_cube;
    }
    gl_texture_cube_array* build_texture_cube_array(gl_texture_internal_format format, uint32 width, uint32 height, uint32 mipmaps_num, uint32 elements_num)
    {
    ...
    gl_texture_buffer* build_texture_buffer(gl_texture_internal_format internal_format, gl_buffer* buffer)
    {
