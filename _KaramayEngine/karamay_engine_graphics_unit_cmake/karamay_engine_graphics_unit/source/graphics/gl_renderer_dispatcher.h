...
private:
    ...
    {
        static std::string _templates_path = "C:/PrivateRepos/karamay_engine/_KaramayEngine/karamay_engine_graphics_unit_cmake/karamay_engine_graphics_unit/shaders/templates";
