...
struct gl_tessellation_control_shader_parameters
{
...
public:
	...
	gl_tessellation_control_shader(const gl_tessellation_control_shader_parameters& parameters) :
		parameters(parameters)
	{}

public:

	const gl_tessellation_control_shader_parameters parameters;
