...
public:
		...
		_descriptor(descriptor)
	{
		glTextureStorage3D(
			...
			static_cast<GLenum>(_descriptor.format), _descriptor.width, _descriptor.width,
...
public:
	...
	void fill(std::int32_t element_index, gl_cube_face_index face_index, std::int32_t mipmap_index, std::int32_t x_offset, std::int32_t y_offset, const void* data, std::int32_t width, std::int32_t height)
	{
		glTexSubImage3D(
